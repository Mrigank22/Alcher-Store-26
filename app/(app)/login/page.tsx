    ...
    <AuthLayout>
        <div className="bg-white w-full max-w-[850px] rounded-[30px] shadow-2xl p-8 sm:p-12 md:p-14 border border-gray-100 relative mt-4">
          ...
          <div className="flex justify-center mt-20">
            <button type="button" onClick={() => signIn("google", { callbackUrl: "/profile" })} className="flex items-center gap-3 bg-white border border-gray-300 hover:bg-gray-50 text-black font-bold py-3 px-8 rounded-full shadow-sm transition-all text-sm sm:text-base group">
